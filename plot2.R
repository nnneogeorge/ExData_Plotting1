...
#plot2
#the days are written in German due to my regional settings
plot(dataImport.sub$Date_Time, dataImport.sub$Global_active_power, type= 'l', xlab= " ", ylab="Global Active Power (kilowatts)")
